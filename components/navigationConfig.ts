    ...
    items: [
      {
        ...
        keywords: ["scry", "search", "find", "specimen", "lookup", "query", "web", "grounding", "embedding", "vector", "semantic", "tags", "shadow memory", "trend", "discover", "curiosity", "patterns"],
      },
      {
        mode: "mesopic-lens",
        label: "Mesopic Lens",
        note: "twilight readings · profile × celestial × web",
        keywords: [
          "mesopic",
          "mesopic lens",
          "obsidian mirror",
