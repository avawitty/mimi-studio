...
export const AnalysisDisplay: React.FC<{ 
 ...
 <div className="w-full space-y-12 px-6 md:px-24">
 <SectionHeader label="Celestial Calibration" icon={Moon} style={{ color: accentColor }} />
 <div className="flex flex-col items-center text-center space-y-12">
 <div className="p-8 rounded-none border bg-transparent animate-pulse-slow" style={{ borderColor: 'var(--zine-border)' }}>
 <CelestialIcon size={48} style={{ color: accentColor }} />
 </div>
 <p className="font-mono text-xl md:text-3xl uppercase tracking-widest leading-relaxed max-w-2xl border-l-2 pl-8 text-left" style={{ borderColor: accentColor, color: 'var(--zine-text, #1c1917)' }}>
