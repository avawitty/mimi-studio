const AUTH_DOMAIN_HINT =
  "Add this site in Firebase Console → Authentication → Settings → Authorized domains (e.g. mimi.you, mimi.rip, avainlife.com, and your Vercel *.vercel.app preview URL).";
