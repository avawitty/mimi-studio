const AUTH_DOMAIN_HINT =
  "Add this site in Firebase Console → Authentication → Settings → Authorized domains (e.g. www.mimi.you, mimi.you, avainlife.com, and your Vercel *.vercel.app preview URL).";
