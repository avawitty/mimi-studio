...
export const MIMI_PRICE_ID_PLAN_MAP: Record<string, MimiPlan> = {
  ...
  price_1TyH1ePelakqdIL6VpQHXEKG: "lab",
  price_1TyHpcPelakqdIL6zNy9Pr9n: "initiation",
...
export const MIMI_PLAN_METADATA: Record<MimiPlan, MimiPlanMetadata> = {
  ...
  initiation: {
    ...
    priceLabel: "$12/mo",
    creditLabel: "Understand your taste",
    credits: 500,
    billingCadence: "month",
    summary: "Interpreter tier — Mimi starts remembering you.",
    bullets: [
  ...
  optioning: {
    ...
    label: "Optioning",
    priceLabel: "$25/mo",
    creditLabel: "Tailor your taste",
    credits: 1500,
    billingCadence: "month",
    summary: "Tailor tier — most chosen for serious styling work.",
    bullets: [
  ...
  atelier: {
    ...
    label: "The Atelier",
    priceLabel: "$40/mo",
    creditLabel: "Apply your taste",
    credits: 3000,
    billingCadence: "month",
    summary: "Couturier tier — produce and position the signal.",
    bullets: [
  ...
  lab: {
    ...
    label: "The Lab",
    priceLabel: "$99/mo",
    creditLabel: "Shape the system",
    credits: 10000,
    billingCadence: "month",
    summary: "Maison tier — experimental controls and integrations.",
    bullets: [
