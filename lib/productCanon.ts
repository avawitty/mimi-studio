...
export const CANON_MODULES: CanonModule[] = [
  ...
  },
  {
    ...
    aliases: ["Orientation", "Intake", "Studio", "Worktable"],
    ...
    userFlow:
      "Land on the archival worktable desk — prompt cycles, instruments, aura meter, and context strip. Optional calm orientation intake at /studio/orientation. Full console via Console escape hatch.",
    notes:
      "Primary /studio mounts StudioWorktable. Alternate orientation intake: /studio/orientation.",
    family: "orientation",
    phase: "compose",
    visibility: "primary",
