...
context remains in [Architecture Update 20](./architecture-update-20.md) and
[Architecture Update 21](./architecture-update-21.md). Migration inventory:
[Neon operational spine audit](./neon-operational-spine-audit.md).
