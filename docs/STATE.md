...
| **Tailor** | `/tailor` | shipped | Style Lab / Diagnostics aliased routes; **Owner Slide Templates** UI; evidence intake **local-first** when Firestore quota/offline; Let Mimi Read You flow simplified | Wire Doll ↔ Rip handoff CTAs (`prd/chamber-loop-…`) |
