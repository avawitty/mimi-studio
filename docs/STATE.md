...
| **Taste Intelligence OS v2** | `/tailor/calibrate` | **partial** | Calibration Lab + Neon APIs; negative taste + graph editing; Scry rerank; Pocket why-saved; Studio compiler/critic cards with Tailor v2 contract reconciliation | merge/split graph ops |
