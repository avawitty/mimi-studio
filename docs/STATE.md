...
| **Taste Intelligence OS v2** | `/tailor/calibrate` | **partial** | Calibration Lab + Neon APIs; Pocket why-saved sheet shipped; Scry taste rerank shipped | Studio compiler/critic cards; graph editor merge/split |
