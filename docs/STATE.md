...
| **Studio (orientation intake)** | `/studio` | shipped | Archival `StudioWorktable` migration-only at `/studio/worktable-legacy` | Expand card-state pilot to Worktable sheets; keep Used Context visible on generations |
