...
| **Taste Graph** | `/taste-graph` | partial | Summary API + trajectory/tensions; embedding centroid; Studio/Scry auto-embed | Run `taste:backfill-floor-atoms` / `taste:backfill-darkroom-treatments` for historical data |
