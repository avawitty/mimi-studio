...
| **Studio (compose console)** | `/studio` | **partial** | Unified floating pill toolbar + Tools drawer (Anchors, Continuum, Treatments, Context, noise); compact cover colophon; funded gateway patron/trial credit heal | Live telemetry beyond decorative dash; post-intake worktable promotion |
